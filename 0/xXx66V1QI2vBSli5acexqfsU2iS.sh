...
# Run Python script
python src/llm_mutation.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/network.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/models/network_xXx66V1QI2vBSli5acexqfsU2iS.py 0/xXx66V1QI2vBSli5acexqfsU2iS_model.txt --top_p 0.1 --temperature 0.14 --apply_quality_control 'False' --hugging_face True
