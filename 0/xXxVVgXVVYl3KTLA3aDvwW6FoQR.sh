...
# Run Python script
python src/llm_mutation.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/network.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/models/network_xXxVVgXVVYl3KTLA3aDvwW6FoQR.py 0/xXxVVgXVVYl3KTLA3aDvwW6FoQR_model.txt --top_p 0.1 --temperature 0.17 --apply_quality_control 'False' --hugging_face True
