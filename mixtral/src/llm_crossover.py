...
from llm_utils import split_file, submit_mixtral, sibmit_mixtral_hf, llm_code_qc, str2bool, extract_note, generate_augmented_code, clean_code_from_llm, retrieve_base_code
...
def augment_network(input_filename_x, input_filename_y, output_filename,
    ...
    template_path = f'/gv1/projects/AI_Surrogate/dev/clint/CodeLLama/codellama/mixtral/templates/{template_fname}'
