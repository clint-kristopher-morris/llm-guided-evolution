...
# Run Python script
python src/llm_mutation.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/network.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/models/network_xXxDlFXp72u3Hw7iVV8zFYOf5ok.py 0/xXxDlFXp72u3Hw7iVV8zFYOf5ok_model.txt --top_p 0.1 --temperature 0.18 --apply_quality_control 'False' --hugging_face True
