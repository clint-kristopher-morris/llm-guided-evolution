...
# Run Python script
python src/llm_mutation.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/network.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/models/network_xXxPUe21O5x2tD3ESCVh73e2wpz.py 0/xXxPUe21O5x2tD3ESCVh73e2wpz_model.txt --top_p 0.1 --temperature 0.14 --apply_quality_control 'False' --hugging_face True
