...
# Run Python script
python src/llm_mutation.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/network.py /storage/ice1/2/6/madewolu9/LLM_PointNet/LLM-Guided-PointCloud-Class/sota/ExquisiteNetV2/models/network_xXxa4CRzz1OM3hegbx1i9BTWX8F.py 0/xXxa4CRzz1OM3hegbx1i9BTWX8F_model.txt --top_p 0.1 --temperature 0.14 --apply_quality_control 'False' --hugging_face True
